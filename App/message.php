      ...
      <div class="flex flex-col py-8 pl-6 pr-2 w-64 bg-white flex-shrink-0">
        ...
        >
          <div class="h-20 w-20 rounded-full border overflow-hidden">
            <img
              src="./assets/img/tempusers/user2.jpg"
              alt="logo"
              class="h-full w-full"
            />
          </div>
          <div class="text-sm font-semibold mt-2"><?php echo "$firstname $lastname"?></div>
          <div class="text-xs text-gray-500"><?php echo "$userType"?></div>
        ...
        <div class="flex flex-col mt-8">
          ...
          <div class="flex flex-col space-y-1 mt-4 -mx-2 h-48 overflow-y-auto">
            ...
            >
              ...
              <div class="ml-2 text-sm font-semibold">Alex Ng'ang'a</div>
            </button>
            <button
              class="flex flex-row items-center hover:bg-gray-100 rounded-xl p-2"
            >
              ...
              <div class="ml-2 text-sm font-semibold">John Doe</div>
              <div
            ...
            >
              ...
              <div class="ml-2 text-sm font-semibold">Mary Bett</div>
            </button>
          ...
          <div class="flex flex-col space-y-1 mt-4 -mx-2">
            ...
            >
              ...
              <div class="ml-2 text-sm font-semibold">Safe Space</div>
            </button>
          </div>
        </div>
      </div>
